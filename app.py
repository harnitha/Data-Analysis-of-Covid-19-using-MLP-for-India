...
app.layout = html.Div(children=[
    html.H1(children='ANALYSIS OF CASES FOR INDIA AND WORLD'),

    html.Div(children=''' '''), dcc.Graph(id='fig1',figure=fig1),
    html.Div(children='''Comparison between Total Confirmed,Recovered and Deceased Cases for India'''), dcc.Graph(id='fig2',figure=fig2),
    html.Div(children='''Comparison between Daily Confirmed,Recovered and Deceased Cases for India '''), dcc.Graph(id='fig3',figure=fig3),
    ...
    html.Div(children=''' '''), dcc.Graph(id='fig11',figure=fig11)
])
